...
namespace Eyer
{
    ...
    int EyerPlayerCallback::OnOpen(MediaInfo & mediaInfo)
    {
        ...
        jmethodID eyerCallbackMethod_onOpen = env->GetMethodID(eyerCallbackClass, "onOpen", "(II)I");
        ...
        int ret = env->CallIntMethod(callback, eyerCallbackMethod_onOpen, width, height);
