...
namespace Eyer
{
    EyerMediaCodec2::EyerMediaCodec2()
    {
    ...
    int EyerMediaCodec2::Init(EyerAVStream & stream, jobject surface)
    {
        JNIEnv * env = Eyer::EyerJNIEnvManager::AttachCurrentThread();
    ...
    int EyerMediaCodec2::SendPacket(Eyer::EyerAVPacket * annexbPkt)
    {
        JNIEnv * env = Eyer::EyerJNIEnvManager::AttachCurrentThread();
    ...
    int EyerMediaCodec2::RecvFrameRender()
    {
        int ret = 0;
    ...
    int EyerMediaCodec2::DequeueOutputBuffer()
    {
        JNIEnv * env = Eyer::EyerJNIEnvManager::AttachCurrentThread();
    ...
    long EyerMediaCodec2::GetOutTime()
    {
        JNIEnv * env = Eyer::EyerJNIEnvManager::AttachCurrentThread();
    ...
    int EyerMediaCodec2::RenderFrame(int outindex)
    {
        JNIEnv * env = Eyer::EyerJNIEnvManager::AttachCurrentThread();
