...
namespace Eyer
{
    ...
    )
    {
        ...
        int channels = av_get_channel_layout_nb_channels(piml->inputChannelLayout.ffmpegId);
    ...
    int EyerAVResample::PutAVFrame(EyerAVFrame & frame)
    {
        ...
        while(1){
            ...
            inputFrame.piml->frame->channel_layout      = piml->inputChannelLayout.ffmpegId;
            ...
            outputFrame.piml->frame->channel_layout     = piml->outputChannelLayout.ffmpegId;
    ...
    int EyerAVResample::GetLastFrame(EyerAVFrame & frame, int frameSize)
    {
        ...
        if(size < frameSize){
            ...
            fillFrame.piml->frame->channel_layout       = piml->outputChannelLayout.ffmpegId;
    ...
    int EyerAVResample::GetFrame(EyerAVFrame & frame, int frameSize)
    {
        ...
        frame.piml->frame->channel_layout       = piml->outputChannelLayout.ffmpegId;
