...
/c/jdk/bin/javac -h ./ ${basepath}/EyerPlayerAndroid/eyerplayer_lib/src/main/java/com/eyer/eyerplayer/EyerPlayerJNI.java -classpath ${ANDROID_SDK_HOME}/platforms/android-22/android.jar:.
